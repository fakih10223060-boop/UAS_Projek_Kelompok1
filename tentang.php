...
// --- LOGIKA DATA (PHP) ---
$data = [
    "visi" => "Membangun tatanan sosial yang mandiri, adil, dan berkelanjutan melalui
penguatan sumber daya manusia dan ekonomi masyarakat.",
    "misi" => [
        "Meningkatkan kualitas hidup masyarakat melalui program sosial,
pendidikan, dan kesehatan.",
        "Menciptakan lingkungan sosial yang mendukung anak yatim, difabel, dan
masyarakat rentan.",
        "Mengembangkan model pemberdayaan ekonomi dan keterampilan untuk
...
<body class="bg-slate-50 text-slate-800">
    ...
    <section class="container mx-auto px-6 py-16 md:py-24 flex flex-col md:flex-row items-center">
        <div class="md:w-1/2 mb-12 md:mb-0">
            <h1 class="text-4xl md:text-6xl font-extrabold text-slate-900 mb-6 leading-tight">
                Mengubah <span class="text-blue-600 text-transparent bg-clip-text bg-gradient-to-r from-blue-600 to-indigo-500">Niat Baik </span> Menjadi <span class="text-blue-600 text-transparent bg-clip-text bg-gradient-to-r from-blue-600 to-indigo-500">Nyata
            </h1>
            <p class="text-slate-600 text-lg mb-8 max-w-lg leading-relaxed">
                Kami adalah lembaga kemanusiaan yang berdedikasi untuk memuliakan anak yatim dan memberdayakan dhuafa melalui aksi nyata di seluruh Indonesia.
            </p>
            
        </div>
        <div class="md:w-1/2">
            <img src="asset/galeri/program5.jpeg" alt="Sosial" class="rounded-[2rem] shadow-2xl rotate-2 hover:rotate-0 transition duration-500">
        </div>
    </section>
    ...
    <section class="bg-white py-20">
        <div class="container mx-auto px-6 grid md:grid-cols-2 gap-12">
            <div class="p-10 bg-slate-50 rounded-3xl border border-slate-100">
                <div class="w-12 h-12 bg-blue-100 text-blue-600 rounded-lg flex items-center justify-center mb-6 text-xl">
            ...
            <div class="p-10 bg-blue-600 rounded-3xl text-white shadow-xl">
                ...
                <h3 class="text-2xl font-bold mb-4 text-white">Misi Kami</h3>
    ...
    <section class="py-24">
        <div class="container mx-auto px-6 text-center max-w-4xl">
            ...
            <div class="bg-white p-12 rounded-[2.5rem] shadow-sm border border-slate-100 leading-loose text-lg text-slate-600">
                <?= $data['sejarah']; ?>
            </div>
        </div>
    </section>
        ...
        <div class="container mx-auto px-6">
            <div class="grid grid-cols-2 md:grid-cols-4 gap-12 text-center">
                ...
                <div>
                    ...
                    <div class="text-blue-100 font-medium uppercase text-xs tracking-widest"><?= $s['label']; ?></div>
                </div>
                <?php endforeach; ?>
            </div>
        </div>
        ...
        <div class="container mx-auto px-6">
            ...
            <div class="grid md:grid-cols-2 gap-8">
                ...
                <div class="p-8 bg-slate-50 rounded-3xl border border-slate-100 relative">
                    ...
                    <p class="text-slate-600 mb-8 italic text-lg relative z-10">"<?= $t['pesan']; ?>"</p>
